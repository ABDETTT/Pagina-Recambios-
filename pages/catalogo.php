...
try {
    ...
    if ($busqueda) {
        $query_parts[] = "AND (p.nombre ILIKE :s OR p.descripcion ILIKE :s)";
        $params['s'] = "%$busqueda%";
    }
                      ...
                      <div class="col-md-6 d-flex flex-column h-100">
                          ...
                          if (!empty($p['categoria_id'])) {
                              try {
                                  ...
                                  // Si hay error en la DB, ignoramos los relacionados pero NO rompemos la página
                                  $relacionados = [];
                              }
                          }
                          ?>
                          ...
                          <div class="mt-auto pt-3 border-top">
                              ...
                              <div class="row g-2">
                                  <?php foreach($relacionados as $rel): ?>
                                      <?php $foto_rel = !empty($rel['imagen']) ? 'img/productos/' . $rel['imagen'] : 'img/productos/placeholder.png'; ?>
