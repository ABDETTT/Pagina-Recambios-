...
<?php
$notificaciones = [
    'eliminado' => ['tipo' => 'success', 'icono' => 'bi-trash-fill',                'titulo' => '¡Producto eliminado!', 'mensaje' => 'El repuesto se ha borrado correctamente de la base de datos.'],
    'error'     => ['tipo' => 'danger',  'icono' => 'bi-exclamation-triangle-fill', 'titulo' => 'Error:',               'mensaje' => 'No se pudo eliminar el producto. Puede que esté asociado a un pedido o coche.'],
    'creado'    => ['tipo' => 'success', 'icono' => 'bi-check-circle-fill',         'titulo' => '¡Éxito!',              'mensaje' => 'Producto añadido correctamente.'],
    'editado'   => ['tipo' => 'success', 'icono' => 'bi-check-circle-fill',         'titulo' => '¡Éxito!',              'mensaje' => 'Producto actualizado correctamente.'],
    'agregado'  => ['tipo' => 'success', 'icono' => 'bi-cart-check-fill',           'titulo' => '¡Añadido!',            'mensaje' => 'El producto se ha añadido a tu carrito.'],
];
      ...
      <div class="container">
          <div class="row text-center g-4">
              <article class="col-6 col-md-3 anim fade-up delay-1">
                  <span class="feature-icon-wrap"><i class="bi bi-truck display-5 text-naranja mb-3 d-block"></i></span>
              ...
              <article class="col-6 col-md-3 anim fade-up delay-2">
                  <span class="feature-icon-wrap"><i class="bi bi-shield-check display-5 text-naranja mb-3 d-block"></i></span>
              ...
              <article class="col-6 col-md-3 anim fade-up delay-3">
                  <span class="feature-icon-wrap"><i class="bi bi-arrow-return-left display-5 text-naranja mb-3 d-block"></i></span>
              ...
              <article class="col-6 col-md-3 anim fade-up delay-4">
                  <span class="feature-icon-wrap"><i class="bi bi-headset display-5 text-naranja mb-3 d-block"></i></span>
