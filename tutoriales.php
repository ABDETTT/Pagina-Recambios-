    ...
    <div class="container">
        <div class="row g-4" id="contenedor-videos">
            <?php foreach($tutoriales as $tut): ?>
                <article class="col-md-6 col-lg-4 tarjeta-tut" data-categoria="<?= htmlspecialchars($tut['filtro']) ?>">
                    <div class="card h-100 shadow-sm border-0 card-hover rounded-4 overflow-hidden">
                        <div class="ratio ratio-16x9">
                            <iframe src="https://www.youtube.com/embed/<?= htmlspecialchars($tut['id_yt']) ?>" loading="lazy" title="<?= htmlspecialchars($tut['titulo']) ?>" allowfullscreen></iframe>
                        </div>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <a href="<?= htmlspecialchars($tut['enlace']) ?>" class="btn btn-outline-primary btn-sm mt-auto fw-bold rounded-pill"><?= htmlspecialchars($tut['btn_texto']) ?></a>
                        </div>
                    </div>
                </article>
            <?php endforeach; ?>
