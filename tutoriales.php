...
$tutoriales = [
    [
        ...
        "enlace" => "/RecambiosPro/pages/catalogo.php?categoria=1",
    ...
    [
        ...
        "enlace" => "/RecambiosPro/pages/catalogo.php?categoria=2",
    ...
    [
        ...
        "enlace" => "/RecambiosPro/pages/catalogo.php?categoria=3",
    ...
    [
        ...
        "enlace" => "/RecambiosPro/pages/catalogo.php",
...
<main class="bg-light pb-5">
    <section class="bg-dark text-white py-5 mb-5 text-center" style="background: linear-gradient(rgba(0,36,107,0.9), rgba(0,0,0,0.9)), url('/RecambiosPro/assets/img/img4.png'); background-size: cover; background-position: center;">
